...
# define YYTOKENTYPE
   ...
   enum yytokentype {
     ...
     AT_SYNCHRONIZED = 343,
     AT_DEFS = 344,
     AT_AUTORELEASEPOOL = 345,
     AT_UNSAFE_UNRETAINED = 346,
     AT_AUTORELEASING = 347,
     IDENTIFIER = 348,
     TYPE_NAME = 349,
     CONSTANT = 350,
     STRING_LITERAL = 351,
     AT_STRING_LITERAL = 352
   };
#endif
/* Tokens.  */
#define SIZEOF 258
...
#define WEAK 341
#define STRONG 342
#define AT_SYNCHRONIZED 343
#define AT_DEFS 344
#define AT_AUTORELEASEPOOL 345
#define AT_UNSAFE_UNRETAINED 346
#define AT_AUTORELEASING 347
#define IDENTIFIER 348
#define TYPE_NAME 349
#define CONSTANT 350
#define STRING_LITERAL 351
#define AT_STRING_LITERAL 352
