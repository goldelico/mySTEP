...
#define XCTAssertEqualPointsWithAccuracy(p1, p2, acc...) XCTAssertEqualWithAccuracy(p1.x, p2.x, acc); XCTAssertEqualWithAccuracy(p1.y, p2.y, acc);
#define XCTAssertEqualSizesWithAccuracy(s1, s2, acc...) XCTAssertEqualWithAccuracy(s1.width, s2.width, acc); XCTAssertEqualWithAccuracy(s1.height, s2.height, acc);
...
- (void) test03
{
	...
	XCTAssertEqualWithAccuracy(ts.m12, (CGFloat) 0.5, 2e-6);
	XCTAssertEqualWithAccuracy(ts.m21, (CGFloat) -0.5, 2e-6);
