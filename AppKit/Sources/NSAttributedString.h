/* 
   ...
   Author:	Fabian Spillner <fabian.spillner@gmail.com>
   Date:	14. November 2007 - aligned with 10.5 - only category NSMutableAttributedStringAdditions
...
- (NSUInteger) lineBreakBeforeIndex:(NSUInteger) loc withinRange:(NSRange) range;
- (NSUInteger) lineBreakByHyphenatingBeforeIndex:(NSUInteger) loc withinRange:(NSRange) range;
- (NSUInteger) nextWordFromIndex:(NSUInteger) loc forward:(BOOL) isForward;
